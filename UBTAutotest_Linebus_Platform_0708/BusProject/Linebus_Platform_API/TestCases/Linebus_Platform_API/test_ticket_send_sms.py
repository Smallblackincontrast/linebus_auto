# -*- coding:utf-8 -*-
# @Time     :2019/7/16 17:55
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_ticket_send_sms.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("ticket_send_sms")


@ddt
class TestTicketSendSms(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_ticket_send_sms(self, datas):

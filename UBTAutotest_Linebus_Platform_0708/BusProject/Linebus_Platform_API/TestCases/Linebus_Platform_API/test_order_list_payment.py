...
# @File     :test_order_list_payment.py
# @software :PyCharm
import unittest
import csv
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("order_list_payment")


@ddt
class TestOrderListPayment(unittest.TestCase):
    ...
    @data(*testdata)
    def test_order_list_payment(self, datas):

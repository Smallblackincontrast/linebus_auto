...
# @File     :test_ticketnote_log_save_v2.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("ticketnote_log_save_v2")


@ddt
class TestTicketopLogSaveV2(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_ticketnote_log_save_v2(self, datas):

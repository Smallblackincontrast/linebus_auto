...
# @File     :test_busfraudapi_trans_approve.py
# @software :PyCharm
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("busfraudapi_trans_approve")


@ddt
class TestBusfraudapiTransApprove(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_busfraudapi_trans_approve(self, datas):

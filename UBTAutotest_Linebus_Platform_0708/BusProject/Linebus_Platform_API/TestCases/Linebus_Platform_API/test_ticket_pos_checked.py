# -*- coding:utf-8 -*-
# @Time     :2019/7/11 11:15
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_ticket_pos_checked.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("ticket_pos_checked")


@ddt
class TestTicketPosChecked(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_ticket_pos_checked(self, datas):

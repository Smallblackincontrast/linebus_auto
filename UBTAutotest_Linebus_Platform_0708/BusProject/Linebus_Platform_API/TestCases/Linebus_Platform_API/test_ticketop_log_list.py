# -*- coding:utf-8 -*-
# @Time     :2019/7/17 16:15
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_ticketop_log_list.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("ticketop_log_list")


@ddt
class TestTicketopLogList(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_ticketop_log_list(self, datas):

#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @File  : test_order_report_repeatpurchase.py
# @Author  : Ruanzhe@riverroad.cn
# @Date  : 2019/6/24  17:29
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("order_report_repeatpurchase")


@ddt
class TestOrderReportRepeatpurchase(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_order_report_repeatpurchase(self, datas):

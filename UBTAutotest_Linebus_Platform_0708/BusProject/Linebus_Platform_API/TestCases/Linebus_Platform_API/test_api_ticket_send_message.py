# -*- coding:utf-8 -*-
# @Time     :2019/7/24 17:40
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_api_ticket_send_message.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("api_ticket_send_message")


@ddt
class TestApiTicketSendMessage(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_api_ticket_send_message(self, datas):

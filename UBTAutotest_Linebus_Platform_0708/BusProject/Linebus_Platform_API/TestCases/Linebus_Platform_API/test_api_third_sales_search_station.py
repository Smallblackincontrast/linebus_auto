# -*- coding:utf-8 -*-
# @Time     :2019/7/23 11:25
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_api_third_sales_search_station.py
# @software :PyCharm
import unittest
import csv
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("api_third_sales_search_station")


@ddt
class TestApiThirdSalesSearchStation(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_api_third_sales_search_station(self, datas):

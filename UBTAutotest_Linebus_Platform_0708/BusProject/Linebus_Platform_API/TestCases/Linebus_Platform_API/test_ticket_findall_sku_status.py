# -*- coding:utf-8 -*-
# @Time     :2019/7/10 17:48
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_ticket_findall_sku_status.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("ticket_findall_sku_status")


@ddt
class TestTicketFindallSkuStatus(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_ticket_findall_sku_status(self, datas):

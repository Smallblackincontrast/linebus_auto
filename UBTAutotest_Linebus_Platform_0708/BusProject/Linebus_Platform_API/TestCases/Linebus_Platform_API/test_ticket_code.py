# -*- coding:utf-8 -*-
# @Time     :2019/7/10 17:18
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_ticket_code.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("ticket_code")


@ddt
class TestTicketCode(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_ticket_code(self, datas):

# -*- coding:utf-8 -*-
# @Time     :2019/7/11 13:38
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_ticket_pos_printlog.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("ticket_pos_printlog")


@ddt
class TestTicketPosPrintlog(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
        ...
        setattr(CD, "device_deviceid", device_data[0]["device_id"])
        # 查询已检票的票
    ...
    @data(*testdata)
    def test_ticket_pos_printlog(self, datas):

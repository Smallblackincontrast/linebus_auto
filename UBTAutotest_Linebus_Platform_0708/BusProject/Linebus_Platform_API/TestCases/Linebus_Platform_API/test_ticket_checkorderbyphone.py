# -*- coding:utf-8 -*-
# @Time     :2019/7/10 14:50
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_ticket_checkorderbyphone.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("ticket_checkorderbyphone")


@ddt
class TestTicketCheckorderbyphone(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_ticket_checkorderbyphone(self, datas):

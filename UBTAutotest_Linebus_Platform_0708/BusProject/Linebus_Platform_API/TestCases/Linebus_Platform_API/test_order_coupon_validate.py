#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @File  : test_order_coupon_validate.py
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("order_coupon_validate")


@ddt
class TestOrderCouponValide(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.log.info("新增的订单信息为：" + str(cls.new_order.json()))
        setattr(CD, "order_id", int(cls.new_order.json()["result"]["id"]))
    ...
    @data(*testdata)
    def test_order_coupon_validate(self, datas):

# -*- coding:utf-8 -*-
# @Time     :2019/7/22 16:55
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_api_third_sales_login.py
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("api_third_sales_login")


@ddt
class TestApiThirdSalesLogin(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_api_third_sales_login(self, datas):

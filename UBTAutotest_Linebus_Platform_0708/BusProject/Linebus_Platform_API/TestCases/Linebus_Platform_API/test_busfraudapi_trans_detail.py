...
# @File     :test_busfraudapi_trans_detail.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("busfraudapi_trans_detail")


@ddt
class TestBusfraudapiTransDetail(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_credit_card_payment_detail(self, datas):

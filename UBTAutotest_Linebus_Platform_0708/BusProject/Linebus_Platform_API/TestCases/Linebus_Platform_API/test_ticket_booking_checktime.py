...
# @File     :test_ticket_booking_checktime.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("ticket_booking_checktime")


@ddt
class TestTicketBookingChecktime(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_ticket_booking_checktime(self, datas):

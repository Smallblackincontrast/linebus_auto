# -*- coding:utf-8 -*-
# @Time     :2019/7/23 18:01
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_pos_order_sales_report.py
# @software :PyCharm
import unittest
import csv
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("pos_order_sales_report")


@ddt
class TestPosOrderSalesReport(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_pos_order_sales_report(self, datas):

...
# @File     :test_transaction_creditcard_payrecd.py
# @software :PyCharm
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("transaction_creditcard_payrecd")


@ddt
class TestTransactionCreditcardPayrecd(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_transaction_creditcard_payrecd(self, datas):

# -*- coding:utf-8 -*-
# @Time     :2019/7/22 14:25
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_ticketrefund_listpage.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("ticketrefund_listpage")


@ddt
class TestTicketrefundListpage(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_ticketrefund_listpage(self, datas):

#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @File  : test_order_report_type_count.py
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("order_report_type_count")


@ddt
class TestOrderReportTypeCount(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_order_report_type_count(self, datas):

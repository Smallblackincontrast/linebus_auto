# -*- coding:utf-8 -*-
# @Time     :2019/7/24 14:51
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_api_ticket_search_order.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("api_ticket_search_order")


@ddt
class TestApiTicketSearchOrder(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
        ...
        setattr(CD, "order_id", ticket_data[-1]["order_id"])

# -*- coding:utf-8 -*-
# @Time     :2019/7/19 13:59
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_wallet_search_walletlog.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("wallet_search_walletlog")


@ddt
class TestWalletSearchWalletlog(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_wallet_search_walletlog(self, datas):

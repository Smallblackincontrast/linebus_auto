# -*- coding:utf-8 -*-
# @Time     :2019/7/10 14:45
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_ticket_checkorderbyemail.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("ticket_checkorderbyemail")


@ddt
class TestTicketCheckorderbyemail(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_ticket_checkorderbyemail(self, datas):

# -*- coding:utf-8 -*-
# @Time     :2019/7/24 13:14
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_order_swap_list_payment.py
# @software :PyCharm
import unittest
import csv
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("order_swap_list_payment")


@ddt
class TestOrderSwapListPayment(unittest.TestCase):
    ...
    @data(*testdata)
    def test_order_swap_list_payment(self, datas):

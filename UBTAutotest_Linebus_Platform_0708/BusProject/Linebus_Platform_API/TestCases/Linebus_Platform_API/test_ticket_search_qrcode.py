...
# @File     :test_ticket_search_qrcode.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("ticket_search_qrcode")


@ddt
class TestTicketSearchQrcode(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
        ...
        setattr(CD,"ticket_qrcode",ticket_data[-1]["qrcode"])
    ...
    @data(*testdata)
    def test_ticket_search_code(self, datas):

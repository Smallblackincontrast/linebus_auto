#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @File  : test_order_report_channel_type_count.py
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("order_report_channel")


@ddt
class TestOrderReportChannelTypeCount(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_order_report_channel_type_count(self, datas):

#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @File  : test_validationcode_sendvalidationcode.py
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("validationcode_send")


@ddt
class TestValidationCodeSendValidationCode(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_validationcode_sendvalidationcode(self, datas):

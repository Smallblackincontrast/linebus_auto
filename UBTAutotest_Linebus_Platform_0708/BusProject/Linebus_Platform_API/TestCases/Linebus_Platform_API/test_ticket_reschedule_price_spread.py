...
# @File     :test_ticket_reschedule_price_spread.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("ticket_reschedule_price_spread")


@ddt
class TestTicketReschedulePriceSpread(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()

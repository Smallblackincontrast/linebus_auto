#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @File  : test_tenant_menu_find_by_tid_and_type.py
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("tenant_menu_find_by_tid_and_typ")


@ddt
class TestTenantMenuDataConfigFindByTidAndType(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_tenant_menu_find_by_tid_and_type(self, datas):

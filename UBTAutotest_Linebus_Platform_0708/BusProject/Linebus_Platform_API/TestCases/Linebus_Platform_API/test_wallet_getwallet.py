# -*- coding:utf-8 -*-
# @Time     :2019/7/19 13:40
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_wallet_getwallet.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("wallet_getwallet")


@ddt
class TestWalletGetwallet(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_wallet_getwallet(self, datas):

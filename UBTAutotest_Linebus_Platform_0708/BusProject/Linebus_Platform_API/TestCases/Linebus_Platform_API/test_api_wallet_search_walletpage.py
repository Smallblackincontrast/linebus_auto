...
# @File     :test_api_wallet_search_walletpage.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("api_wallet_search_walletpage")


@ddt
class TestApiWalletSearchWalletpage(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_api_wallet_search_walletpage(self, datas):

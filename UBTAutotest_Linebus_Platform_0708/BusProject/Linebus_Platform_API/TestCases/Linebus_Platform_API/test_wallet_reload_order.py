# -*- coding:utf-8 -*-
# @Time     :2019/7/19 13:44
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_wallet_reload_order.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("wallet_reload_order")


@ddt
class TestWalletReloadOrder(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_wallet_reload_order(self, datas):

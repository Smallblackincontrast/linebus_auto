#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @File  : test_userinfo_register.py
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("userinfo_register")


@ddt
class TestUserInfoRegister(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_userinfo_register(self, datas):

# -*- coding:utf-8 -*-
# @Time     :2019/7/17 15:18
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_ticketop_log_check.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("ticketop_log_check")


@ddt
class TestTicketopLogCheck(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_ticketop_log_check(self, datas):

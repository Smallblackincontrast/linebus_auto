...
# @File     :test_api_ticket_search_user.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("api_ticket_search_user")


@ddt
class TestApiTicketSearchUser(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_api_ticket_search_user(self, datas):

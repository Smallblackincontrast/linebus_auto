# -*- coding:utf-8 -*-
# @Time     :2019/7/23 16:57
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_pos_order_inventory.py
# @software :PyCharm
import unittest
import csv
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("pos_order_inventory")


@ddt
class TestPosOrderInventory(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_pos_order_inventory(self, datas):

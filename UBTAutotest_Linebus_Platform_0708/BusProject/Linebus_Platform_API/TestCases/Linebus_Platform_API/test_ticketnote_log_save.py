# -*- coding:utf-8 -*-
# @Time     :2019/7/17 16:41
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_ticketnote_log_save.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("ticketnote_log_save")


@ddt
class TestTicketopLogSave(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_ticketnote_log_save(self, datas):

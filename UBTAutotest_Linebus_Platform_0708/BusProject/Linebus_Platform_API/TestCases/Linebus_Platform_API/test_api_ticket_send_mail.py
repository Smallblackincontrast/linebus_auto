...
# @File     :test_api_ticket_send_mail.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("api_ticket_send_mail")


@ddt
class TestApiTicketSendMail(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_api_ticket_send_mail(self, datas):

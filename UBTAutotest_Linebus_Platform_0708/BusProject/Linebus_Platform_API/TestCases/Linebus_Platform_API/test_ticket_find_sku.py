# -*- coding:utf-8 -*-
# @Time     :2019/7/10 17:27
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_ticket_find_sku.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("ticket_find_sku")


@ddt
class TestTicketFindSku(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_ticket_find_sku(self, datas):

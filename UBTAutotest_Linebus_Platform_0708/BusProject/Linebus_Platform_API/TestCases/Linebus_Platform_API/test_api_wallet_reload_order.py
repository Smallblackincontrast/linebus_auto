# -*- coding:utf-8 -*-
# @Time     :2019/7/18 17:39
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_api_wallet_reload_order.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("api_wallet_reload_order")


@ddt
class TestApiWalletReloadOrder(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_api_wallet_reload_order(self, datas):

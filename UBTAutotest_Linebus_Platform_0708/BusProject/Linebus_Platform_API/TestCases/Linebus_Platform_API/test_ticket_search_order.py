# -*- coding:utf-8 -*-
# @Time     :2019/7/16 17:43
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_ticket_search_order.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("ticket_search_order")


@ddt
class TestTicketSearchOrder(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_ticket_search_order(self, datas):

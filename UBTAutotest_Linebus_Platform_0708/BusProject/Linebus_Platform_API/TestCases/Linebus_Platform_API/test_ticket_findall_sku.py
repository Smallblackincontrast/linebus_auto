# -*- coding:utf-8 -*-
# @Time     :2019/7/10 17:39
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_ticket_findall_sku.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("ticket_findall_sku")


@ddt
class TestTicketFindallSku(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_ticket_findall_sku(self, datas):

# -*- coding:utf-8 -*-
# @Time     :2019/7/19 14:34
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_ticketrefund_save_v2.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("ticketrefund_save_v2")


@ddt
class TestTicketrefundSaveV2(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_ticketrefund_save_v2(self, datas):

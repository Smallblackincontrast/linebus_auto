...
# @File     :test_api_third_sales_search_sku.py
# @software :PyCharm
import unittest
import csv
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("api_third_sales_search_sku")


@ddt
class TestApiThirdSalesSearchSku(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_api_third_sales_search_sku(self, datas):

#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @File  : test_order_report_user_type_count.py
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("order_report_user_type_count")


@ddt
class TestOrderReportUserTypeCount(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_order_report_user_type_count(self, datas):

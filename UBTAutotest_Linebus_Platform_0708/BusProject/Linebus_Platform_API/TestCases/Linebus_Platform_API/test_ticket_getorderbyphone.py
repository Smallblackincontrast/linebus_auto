# -*- coding:utf-8 -*-
# @Time     :2019/7/10 16:15
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_ticket_getorderbyphone.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("ticket_getorderbyphone")


@ddt
class TestTicketGetorderbyphone(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
        ...
        cls.api = ApiRequests()
        # 获取手机验证码
        phone_val = ApiRequests().api_request("get", CD.url + r'/api/auth/sendvalidationcode?phone='+quote(CD.user_account),
    ...
    @data(*testdata)
    def test_ticket_getorderbyphone(self, datas):

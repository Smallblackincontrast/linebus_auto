...
# @File     :test_transaction_chargeback.py
# @software :PyCharm
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("transaction_chargeback")


@ddt
class TestTransactionChargeback(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_transaction_chargeback(self, datas):

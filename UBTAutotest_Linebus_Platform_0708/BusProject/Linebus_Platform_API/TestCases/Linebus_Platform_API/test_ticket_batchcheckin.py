# -*- coding:utf-8 -*-
# @Time     :2019/7/10 13:33
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_ticket_batchcheckin.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("ticket_batchcheckin")


@ddt
class TestTicketBatchchechin(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_ticket_batchcheckin(self, datas):

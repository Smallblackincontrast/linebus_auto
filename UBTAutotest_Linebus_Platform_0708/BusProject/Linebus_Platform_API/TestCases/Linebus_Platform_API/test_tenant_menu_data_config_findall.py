#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @File  : test_tenant_menu_data_config_findall.py
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("tenant_menu_data_config_findall")


@ddt
class TestTenantMenuDataConfigFindAll(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_tenant_menu_data_config_dind_all(self, datas):

# -*- coding:utf-8 -*-
# @Time     :2019/7/11 13:56
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_ticket_pos_search_code.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("ticket_pos_search_code")


@ddt
class TestTicketPosSearchCode(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_ticket_pos_search_code(self, datas):

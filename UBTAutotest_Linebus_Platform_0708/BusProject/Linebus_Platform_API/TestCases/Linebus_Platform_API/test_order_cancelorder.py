#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @File  : test_order_cancelorder.py
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("order_cancelorder")


@ddt
class TestOrderCancelOrder(unittest.TestCase):
    ...
    @data(*testdata)
    def test_order_cancelorder(self, datas):

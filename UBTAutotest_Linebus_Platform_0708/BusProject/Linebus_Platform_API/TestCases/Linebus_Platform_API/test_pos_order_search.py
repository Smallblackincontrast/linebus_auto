...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("pos_order_search")


@ddt
class TestPosOrderSearch(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_pos_order_search(self, datas):

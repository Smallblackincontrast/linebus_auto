#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @File  : test_tenant_menu_data_config_find_by_tid.py
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("tenant_menu_config_find_by_tid")


@ddt
class TestTenantMenuDataConfigFindByTid(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_tenant_menu_data_config_find_by_tid(self, datas):

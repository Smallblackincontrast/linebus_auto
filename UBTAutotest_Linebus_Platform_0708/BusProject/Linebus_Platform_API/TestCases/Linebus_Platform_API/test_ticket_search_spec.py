...
# @File     :test_ticket_search_spec.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("ticket_search_spec")


@ddt
class TestTicketSearchSpec(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_ticket_search_spec(self, datas):

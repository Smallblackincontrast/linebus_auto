...
# @File     :test_busfraudapi_trans_reset.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("busfraudapi_trans_reset")


@ddt
class TestBusfraudapiTransReset(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_credit_card_payment_reset(self, datas):

# -*- coding:utf-8 -*-
# @Time     :2019/7/22 17:26
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_api_third_sales_order_add.py
# @software :PyCharm
import unittest
import csv
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("api_third_sales_order_add")


@ddt
class TestApiThirdSalesOrderAdd(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_api_third_sales_order_add(self, datas):

# -*- coding:utf-8 -*-
# @Time     :2019/7/22 18:02
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_api_third_sales_order_cancel.py
# @software :PyCharm
import unittest
import csv
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("api_third_sales_order_cancel")


@ddt
class TestApiThirdSalesOrderCancel(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_api_third_sales_order_cancel(self, datas):

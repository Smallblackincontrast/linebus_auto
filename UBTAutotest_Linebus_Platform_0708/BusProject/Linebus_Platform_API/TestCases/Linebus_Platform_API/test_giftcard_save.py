# -*- coding:utf-8 -*-
# @Time     :2019/7/18 13:39
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_giftcard_save.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("giftcard_save")


@ddt
class TestGiftcardSave(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_giftcard_save(self, datas):

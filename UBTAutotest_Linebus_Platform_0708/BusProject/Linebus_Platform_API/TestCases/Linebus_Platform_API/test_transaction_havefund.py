...
# @File     :test_transaction_havefund.py
# @software :PyCharm
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("transaction_havefund")


@ddt
class TestTransactionHavefund(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_transaction_havefund(self, datas):

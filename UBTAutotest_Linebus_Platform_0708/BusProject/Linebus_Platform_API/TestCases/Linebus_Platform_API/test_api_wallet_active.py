# -*- coding:utf-8 -*-
# @Time     :2019/7/18 14:34
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_api_wallet_active.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("api_wallet_active")


@ddt
class TestApiWalletActive(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_api_wallet_active(self, datas):

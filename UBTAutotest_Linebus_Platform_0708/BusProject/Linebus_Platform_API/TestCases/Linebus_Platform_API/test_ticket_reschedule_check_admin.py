# -*- coding:utf-8 -*-
# @Time     :2019/7/16 14:32
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_ticket_reschedule_check_admin.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("ticket_reschedule_check_admin")


@ddt
class TestTicketRescheduleCheckAdmin(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()

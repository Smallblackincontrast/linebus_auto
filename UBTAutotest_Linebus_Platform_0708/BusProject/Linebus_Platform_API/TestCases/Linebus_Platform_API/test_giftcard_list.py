# -*- coding:utf-8 -*-
# @Time     :2019/7/18 13:36
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_giftcard_list.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("giftcard_list")


@ddt
class TestGiftcardList(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_giftcard_list(self, datas):

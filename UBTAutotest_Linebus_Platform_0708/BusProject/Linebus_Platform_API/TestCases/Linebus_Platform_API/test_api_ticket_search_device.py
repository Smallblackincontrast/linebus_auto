# -*- coding:utf-8 -*-
# @Time     :2019/7/24 14:47
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_api_ticket_search_device.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("api_ticket_search_device")


@ddt
class TestApiTicketSearchDevice(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_api_ticket_search_device(self, datas):

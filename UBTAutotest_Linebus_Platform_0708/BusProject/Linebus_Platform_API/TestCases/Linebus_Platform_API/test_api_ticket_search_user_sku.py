# -*- coding:utf-8 -*-
# @Time     :2019/7/24 16:23
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_api_ticket_search_user_sku.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("api_ticket_search_user_sku")


@ddt
class TestApiTicketSearchUserSku(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
        ...
        cls.api = ApiRequests()
        # 登录
        user_login = cls.api.api_request(
            "post",
        ...
        cls.log.info("获取的线路查询结果为：" + str(search_schedule))
    ...
    @data(*testdata)
    def test_api_ticket_search_user_sku(self, datas):

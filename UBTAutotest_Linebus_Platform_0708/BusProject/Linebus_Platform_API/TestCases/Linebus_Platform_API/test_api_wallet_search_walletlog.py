# -*- coding:utf-8 -*-
# @Time     :2019/7/19 13:29
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_api_wallet_search_walletlog.py
# @software :PyCharm
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("api_wallet_search_walletlog")


@ddt
class TestApiWalletSearchWalletlog(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_api_wallet_search_walletlog(self, datas):

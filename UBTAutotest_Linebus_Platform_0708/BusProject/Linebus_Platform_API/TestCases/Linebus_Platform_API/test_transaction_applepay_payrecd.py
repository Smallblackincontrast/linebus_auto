...
# @File     :test_transaction_applepay_payrecd.py
# @software :PyCharm
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("transaction_applepay_payrecd")


@ddt
class TestTransactionApplepayPayrecd(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_transaction_applepay_payrecd(self, datas):

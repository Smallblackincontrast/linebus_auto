# -*- coding:utf-8 -*-
# @Time     :2019/7/25 15:45
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_api_seat_seatmap.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("api_seat_seatmap")


@ddt
class TestApiSeatSeatmap(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_api_seat_seatmap(self, datas):

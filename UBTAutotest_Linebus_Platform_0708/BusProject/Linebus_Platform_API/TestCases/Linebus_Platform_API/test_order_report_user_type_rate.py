#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @File  : test_order_report_user_type_rate.py
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("order_report_user_type_rate")


@ddt
class TestOrderReportUserTypeRate(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_order_report_user_type_rate(self, datas):

#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @File  : test_order_new_paypel_pay.py
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("order_new_paypel_pay")


@ddt
class TestOrderNewPaypelPay(unittest.TestCase):
    ...
    @data(*testdata)
    def test_order_new_paypel_pay(self, datas):

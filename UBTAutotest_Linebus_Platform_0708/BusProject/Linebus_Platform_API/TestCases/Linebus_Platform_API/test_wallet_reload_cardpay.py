...
# @File     :test_wallet_reload_cardpay.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("wallet_reload_cardpay")


@ddt
class TestWalletReloadCardpay(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
        ...
        cls.wallet_reload_order = cls.api.api_request("post", CD.url + r'/wallet/reload/order?userId=' + CD.userid,
    ...
    @data(*testdata)
    def test_wallet_reload_cardpay(self, datas):

...
# @File     :test_transaction_paypal_payrecd.py
# @software :PyCharm
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("transaction_paypal_payrecd")


@ddt
class TestTransactionPaypalPayrecd(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_transaction_paypal_payrecd(self, datas):

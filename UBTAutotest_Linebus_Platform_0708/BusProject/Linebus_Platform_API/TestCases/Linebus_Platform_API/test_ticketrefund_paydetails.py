# -*- coding:utf-8 -*-
# @Time     :2019/7/19 16:41
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_ticketrefund_paydetails.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("ticketrefund_paydetails")


@ddt
class TestTicketrefundPaydetails(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_ticketrefund_paydetails(self, datas):

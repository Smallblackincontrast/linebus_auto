...
# @File     :test_ticket_sendtickets.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("ticket_sendtickets")


@ddt
class TestTicketSendtickets(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
        ...
        setattr(CD, "schedule_id", ticket_data[-1]["sku_id"])
    ...
    @data(*testdata)
    def test_ticket_sendtickets(self, datas):

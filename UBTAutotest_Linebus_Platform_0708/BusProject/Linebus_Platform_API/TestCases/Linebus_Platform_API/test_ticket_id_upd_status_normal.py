# -*- coding:utf-8 -*-
# @Time     :2019/7/11 10:07
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_ticket_id_upd_status_normal.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("ticket_id_upd_status_normal")


@ddt
class TestTicketIdUpdStatusNormal(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_ticket_id_upd_status_normal(self, datas):

# -*- coding:utf-8 -*-
# @Time     :2019/7/16 16:50
# @Author   :Tester_Wang
# @Email    :wangying@riverroad.com
# @File     :test_ticket_search_sku.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("ticket_search_sku")


@ddt
class TestTicketSearchSku(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_ticket_search_sku(self, datas):

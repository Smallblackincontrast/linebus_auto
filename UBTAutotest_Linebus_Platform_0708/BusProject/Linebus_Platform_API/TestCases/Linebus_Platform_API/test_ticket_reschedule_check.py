...
# @File     :test_ticket_reschedule_check.py
# @software :PyCharm
import unittest
...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("ticket_reschedule_check")


@ddt
class TestTicketRescheduleCheck(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_ticket_reschedule_check(self, datas):

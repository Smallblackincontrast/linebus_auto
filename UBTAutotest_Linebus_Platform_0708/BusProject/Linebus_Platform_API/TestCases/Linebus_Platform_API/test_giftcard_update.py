...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("giftcard_update")


@ddt
class TestGiftcardUpdate(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_giftcard_update(self, datas):
